 ...
 * https://github.com/shentonyan/2012-shentonyan
...
?>
	...
	<footer id="colophon" role="contentinfo">
		<div class="site-info">
			...
			<p>版权所有 &copy; (2024 - <?php echo date( "Y" ); ?>)  <a href="<?php echo esc_url( home_url( "/" ) ); ?>">申吨言</a>│<a href="<?php echo esc_url( home_url( "/wp-sitemap.xml" ) ); ?>">网站地图</a><br>程序：WordPress│主题：<a href="https://github.com/shentonyan/2012-shentonyan">2012-shentonyan</a>│本站禁止任何形式的文章转载<br><?php echo allwords(); ?>
</p>
		</div><!-- .site-info -->
